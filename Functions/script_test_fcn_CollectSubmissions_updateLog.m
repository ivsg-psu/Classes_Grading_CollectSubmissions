...
posixTimeString = sprintf('%9.2f',posixtime(datetime('now')));
processDurationString = sprintf('%.2f',processDuration);
prettyTimeString = sprintf('%s',datetime('now'));
...
%%
Save counts as structure
Set time values explicitly

fcn_CollectSubmissions_updateLog(timeString, processDuration, flagWasSuccessful, totalSame, totalAdded, totalDeleted, totalModified, totalErrored)
